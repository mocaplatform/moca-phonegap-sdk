...
static NSString *const DEFAULT_DEVICE_API_URL = @"https://api-device.mocaplatform.com";
...
/**
 * If enabled, MOCA SDk will perform user syncs with 3rd party systems
 */
@property(nonatomic, readonly) BOOL                userCrmSyncEnabled;
